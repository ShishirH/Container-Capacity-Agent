...
class SystemDump
{
    ...
    {
        LOG.info(String.format("Processes: " + os.getProcessCount() + ", Threads: " + os.getThreadCount() + "%n"));
        // Sort by highest CPU
        ...
        for (int i = 0; i < procs.size() && i < 5; i++)
        {
            ...
            LOG.info(String.format(" %5d %5.1f %4.1f %9s %9s %s%n", p.getProcessID(),
    ...
    private static void printFileSystem(oshi.software.os.FileSystem fileSystem, Logger LOG)
    {
        ...
        LOG.info(String.format(" File Descriptors: %d/%d%n", fileSystem.getOpenFileDescriptors(),
    ...
    private static void printNetworkInterfaces(NetworkIF[] networkIFs, Logger LOG)
    {
        ...
        for (NetworkIF net : networkIFs)
        {
            ...
            LOG.info(String.format("   Traffic: received %s/%s%s; transmitted %s/%s%s %n",
